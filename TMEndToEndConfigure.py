class TMETEcfg(object):
    ...
    RECOGNIZE_MODEL_NAME='optimal0.49613821138211384TMVGG13BNLSTM_2_32_512.pkl'
    DETECT_NUM_CLASS = 1  # +1
    RECOGNIZE_NUM_CLASS=36
    TUPLE_L = (3, 5)  # (4,4)
    DETECT_EXPECTED_IMG_SIZE = (480, 240)
    RECOGNIZE_EXPECTED_IMG_SIZE=(200,32)
    MULTISCALE_SIZE = ((500, 250),(540,270), (600, 300), (640,320),(800, 400))
    ...
    def __init__(self):
        ...
        if self.LOSS=='ECP':
            ...
            self.RECOGNIZE_MODEL_NAME='TMVGG13BN.pkl'
